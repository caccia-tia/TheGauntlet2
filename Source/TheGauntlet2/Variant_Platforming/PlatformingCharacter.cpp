...
void APlatformingCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		//Interact
		EnhancedInputComponent->BindAction(InteractAction, ETriggerEvent::Started, this, &APlatformingCharacter::Interact);
	}
}
...
void APlatformingCharacter::OnMovementModeChanged(EMovementMode PrevMovementMode, uint8 PreviousCustomMode /*= 0*/)
{
	...
	void APlatformingCharacter::Interact()
	{
		...
		if (bHit && HitResult.GetActor())
		{
			...
			// Verifichiamo l'interfaccia senza cast specifici
